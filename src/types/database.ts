  ...
  public: {
    Tables: {
      anchorage_conditions: {
        ...
        Relationships: [
          { foreignKeyName: "anchorage_conditions_run_id_fkey"; columns: ["run_id"]; isOneToOne: false; referencedRelation: "conditions_runs"; referencedColumns: ["id"] },
          { foreignKeyName: "anchorage_conditions_waypoint_id_fkey"; columns: ["waypoint_id"]; isOneToOne: false; referencedRelation: "waypoints"; referencedColumns: ["id"] },
        ]
      }
      app_settings: {
        ...
        Update: { description?: string | null; key?: string; updated_at?: string; value?: Json }
        Relationships: []
      }
      chart_features: {
        Row: { cell_id: string | null; depth_m: number | null; feature_type: string; fetched_at: string; geom: unknown; id: number; properties: Json | null; source: string }
        Insert: { cell_id?: string | null; depth_m?: number | null; feature_type: string; fetched_at?: string; geom: unknown; id?: never; properties?: Json | null; source: string }
        Update: { cell_id?: string | null; depth_m?: number | null; feature_type?: string; fetched_at?: string; geom?: unknown; id?: never; properties?: Json | null; source?: string }
        Relationships: []
      }
      conditions_runs: {
        Row: {
        ...
        Relationships: [
          { foreignKeyName: "conditions_runs_passage_id_fkey"; columns: ["passage_id"]; isOneToOne: false; referencedRelation: "passages"; referencedColumns: ["id"] },
          { foreignKeyName: "conditions_runs_previous_run_id_fkey"; columns: ["previous_run_id"]; isOneToOne: false; referencedRelation: "conditions_runs"; referencedColumns: ["id"] },
        ]
      }
      forecast_atmospheric: {
        ...
        Relationships: [
          { foreignKeyName: "forecast_atmospheric_target_id_fkey"; columns: ["target_id"]; isOneToOne: false; referencedRelation: "ingest_targets"; referencedColumns: ["id"] },
        ]
      }
      forecast_marine: {
        Row: {
        ...
        Relationships: [
          { foreignKeyName: "forecast_marine_target_id_fkey"; columns: ["target_id"]; isOneToOne: false; referencedRelation: "ingest_targets"; referencedColumns: ["id"] },
        ]
      }
      forecast_tidal: {
        Row: {
        ...
        Relationships: [
          { foreignKeyName: "forecast_tidal_target_id_fkey"; columns: ["target_id"]; isOneToOne: false; referencedRelation: "ingest_targets"; referencedColumns: ["id"] },
        ]
      }
      ingest_targets: {
        Row: {
      ...
      passage_briefings: {
        ...
        Relationships: [
          { foreignKeyName: "passage_briefings_passage_id_fkey"; columns: ["passage_id"]; isOneToOne: false; referencedRelation: "passages"; referencedColumns: ["id"] },
          { foreignKeyName: "passage_briefings_run_id_fkey"; columns: ["run_id"]; isOneToOne: false; referencedRelation: "conditions_runs"; referencedColumns: ["id"] },
          { foreignKeyName: "passage_briefings_superseded_by_fkey"; columns: ["superseded_by"]; isOneToOne: false; referencedRelation: "passage_briefings"; referencedColumns: ["id"] },
        ]
      }
      passage_ingest_targets: {
        Row: { passage_id: string; target_id: number }
        Insert: { passage_id: string; target_id: number }
        Update: { passage_id?: string; target_id?: number }
        Relationships: [
          { foreignKeyName: "passage_ingest_targets_passage_id_fkey"; columns: ["passage_id"]; isOneToOne: false; referencedRelation: "passages"; referencedColumns: ["id"] },
          { foreignKeyName: "passage_ingest_targets_target_id_fkey"; columns: ["target_id"]; isOneToOne: false; referencedRelation: "ingest_targets"; referencedColumns: ["id"] },
        ]
      }
      passages: {
        Row: {
        ...
        Relationships: [
          { foreignKeyName: "passages_vessel_id_fkey"; columns: ["vessel_id"]; isOneToOne: false; referencedRelation: "vessels"; referencedColumns: ["id"] },
        ]
      }
      vessels: {
        Row: {
      ...
      waypoint_conditions: {
        ...
        Relationships: [
          { foreignKeyName: "waypoint_conditions_run_id_fkey"; columns: ["run_id"]; isOneToOne: false; referencedRelation: "conditions_runs"; referencedColumns: ["id"] },
          { foreignKeyName: "waypoint_conditions_waypoint_id_fkey"; columns: ["waypoint_id"]; isOneToOne: false; referencedRelation: "waypoints"; referencedColumns: ["id"] },
        ]
      }
      waypoints: {
        Row: {
        ...
        Relationships: [
          { foreignKeyName: "waypoints_passage_id_fkey"; columns: ["passage_id"]; isOneToOne: false; referencedRelation: "passages"; referencedColumns: ["id"] },
        ]
      }
    }
    Views: {
